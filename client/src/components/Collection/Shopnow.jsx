function Shopnow(){
    return(
        ...
        <div className="bg-[#011728] p-4 md:p-4 rounded-lg">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 lg:gap-0 lg:pl-[100px]">
            ...
            <button className="bg-white text-slate-900 px-6 py-2 rounded-full lg:mr-[100px] font-medium hover:bg-gray-200 transition-colors">
              Shop Now
            </button>
          </div>
        </div>
