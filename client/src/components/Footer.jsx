    ...
    <footer className="bg-[#011728] text-white py-8 mt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-3">
              ...
              <a href="#" className="text-gray-400 hover:text-gray-200"><Youtube size={24} /></a>
        ...
        <div className="border-t border-gray-600 mt-6 pt-4 text-center text-gray-400">
          <div>&copy; {new Date().getFullYear()} Amulya Jewels. All Rights Reserved.</div>
          <div className="mt-1">Powered by Idevify Solutions Pvt. Ltd.</div>
        </div>
      </div>
    </footer>
  );
