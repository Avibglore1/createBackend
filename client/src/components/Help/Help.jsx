    ...
    <div className="pt-[64px]">
      ...
      <div className="relative hidden sm:block">
        <img
          src={helpimg2}
          alt=""
          className="absolute right-28 top-0 w-[246px] h-[190px]"
        />
      </div>
      ...
      <div className="pt-8 flex justify-center  w-full">
        <div className="w-full sm:w-[80%] px-4">
          <div className="font-[Montserrat] text-[32px] sm:text-[64px] font-semibold leading-[40px] sm:leading-[78.02px] mb-[40px] sm:mb-[70px] text-left">
            Amulya Jewels Help (FAQ)
          </div>
          ...
          {[
            ...
            <div key={index} className="py-4">
              ...
              {visibleItems[index] && (
                <div className="pl-2 font-[Montserrat] text-[13px] sm:text-[24px] font-extralight leading-[12px] sm:leading-[29.26px] mt-2 pb-2 ">
                  {item.answer}
                </div>
              )}
            </div>
