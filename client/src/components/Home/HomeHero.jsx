...
const HeroSection = () => {
  return (
    <div className="relative pt-16">
      ...
      <div className=" absolute top-[150px]  left-1/2 transform  -translate-x-1/2 -translate-y-1/2 sm:-translate-x-0 sm:-translate-y-0 sm:top-[25px] sm:left-[55px] z-10">
      ...
      <div>
        <img src={Background} alt="back" className=" relative sm:absolute sm:bottom-0 sm:left-1/2 h-[60vh] sm:h-[480px] sm:z-0 object-cover w-screen sm:px-[54px] sm:transform sm:-translate-x-1/2 " />
      </div>
